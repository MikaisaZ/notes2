...
> ![Promise系统学习_promise工作流程](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0_promise%E5%B7%A5%E4%BD%9C%E6%B5%81%E7%A8%8B.png)
...
>
> ![Promise系统学习_回调地狱](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0_%E5%9B%9E%E8%B0%83%E5%9C%B0%E7%8B%B1.jpg)
...
```js
//需求：做一个抽奖系统，中奖则显示中奖信息，未中奖则显示再接再厉
        ...
        //promise的方式
        document.querySelector('button').onclick = function(){
            //promise是一个构造函数，所以我们需要new一下，然后promise需要两个参数，一个是resolve
            //一个是reject我们下面再讲他们的用途
            let p = new Promise((resolve,reject)=>{
                setTimeout(() => {
                let rand = (Math.random()*100)
                if(rand<=50){
                    resolve()//resolve()将promise对象的状态设置为[失败]
                }
                else{
                    reject()//reject()将promise对象的状态设置为[成功]
                }
            }, 1000);
            })
            //那么我们想要成功或者失败后，要提示我们中奖信息的操作该怎么实现呢？很简单，promise的
            //实例对象有个then方法，参数是两个函数，分别代表着成功时与失败时要执行的代码
            p.then(()=>{
                alert('恭喜中奖')//成功时执行这个
            },()=>{
                alert('再接再厉')//失败时执行这个
...
```js
//现在我的需求要增加了，我想要抽奖系统显示出我的中奖或者未中奖号码，让系统更透明，怎么办？

		//其实很简单，resolve和reject函数是可以传参的。传的参数就由then接受
        document.querySelector('button').onclick = function(){
            let p = new Promise((resolve,reject)=>{
                setTimeout(() => {
                let rand = (Math.random()*100)
                if(rand<=50){
                    resolve(rand)//可以用resolve()将中奖号码传递出去
                }
                else{
                    reject(rand)//可以用reject()将未中奖号码传递出去
                }
            }, 1000);
            })
            //那么我们想要成功或者失败后，要提示我们中奖信息的操作该怎么实现呢？很简单，promise的
            //实例对象有个then方法，参数是两个函数，分别代表着成功时与失败时要执行的代码
            p.then((rand)=>{
                alert('恭喜中奖,号码是:'+rand)//成功时执行这个
            },(rand)=>{
                alert('再接再厉,号码是:'+rand)//失败时执行这个
            })
        }
```
...
//运行方式:在该js文件目录下打开终端，然后：node 该文件名.js
```
...
mineReadFile('./test.txt').then((data)=>{
    console.log(data)
},(err)=>{
    console.log(err)
})
...
sendAjax('http://localhost:8080/selectAll').then((data)=>{
    console.log(data)
},(err)=>{
    console.log(err)
})
...
>
> ![image-20220407143712839](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20220407143712839.png)
>
> ```js
...
不要被题目吓到，这个问题其实就是then先指定还是resolve先执行(注意指定和执行的区别)
...
> (1) 简单表达: 由 then()指定的回调函数执行的结果决定。即由then方法的第一个参数和第二个参数决定
>
> (2) 详细表达:
>
...
> throw '出了问题';
>     
> // 2. 返回结果是非 Promise 类型的对象,新 promise 变为 resolved/fullfilled
> return 521;
>     
...
> }).then(value => { 
>     console.log(value);//undefined，因为上一层没有resolve()传参
> })
> </script>
> ```
...
> ```
>
> 注:可以在每个then()的第二个回调函数中进行err处理,也可以利用异常穿透特性,到最后用`catch`去承接统一处理,两者一起用时,前者会生效(因为err已经将其处理,就不会再往下穿透)而走不到后面的catch![image-20210927105504988](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210927105504988.png)
...
>
> ![image-20210926180306961](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210926180306961.png)
...
>
> ![image-20210926182129672](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210926182129672.png)
>
> > 小贴士:此处可能有同学想尝试却发现读取本地文件会有跨域问题,这边教一下你们
>
> > ![image-20210926182506259](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210926182506259.png)
...
> ```
>
> ![image-20210927135255264](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210927135255264.png)
...
> ```js
> async function main(){
>     //1.awiat后面是个promise对象,则返回该promise对象的promiseResult
>     let res = await new Promise((resolve,reject)=>{
>         resolve('OK')
>     })
>     console.log(res)//OK
>     
>     //2.await后面是个其他类型数据，则返回结果就是这个数据本身
>     let res2 = await 521
>     console.log(res2)//521
>     
>     //3.await后面是个promise对象，但是是失败的。
...
async function main(){
    let data1 = await mineReadFile('./ajax.html')
...
> ![image-20210827094130354](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210827094130354.png)
>
...
> ![image-20210827095144833](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210827095144833.png)

## Ⅱ - 尝试输入其他内容进行分析

> ![image-20210827095702736](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210827095702736.png)
>
...
> ![image-20210827100156570](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210827100156570.png)
>
> 大家都是聪明人,看到这个结果应该就不用我组织语言来解释了吧

## Ⅴ - 分析其在宏任务与微任务的打印顺序

> 首先看图:![image-20210827094130354](https://gitee.com/hongjilin/hongs-study-notes/raw/master/%E7%BC%96%E7%A8%8B_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/Promise%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0/A_Promise%E7%B3%BB%E7%BB%9F%E5%AD%A6%E4%B9%A0%E7%AC%94%E8%AE%B0%E4%B8%AD%E7%9A%84%E5%9B%BE%E7%89%87/image-20210827094130354.png)
>
